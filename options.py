...
class TrainOptions():
  def __init__(self):
    ...
    # data loader related
    self.parser.add_argument('--dataroot1', type=str, required=True, help='path of data')
    self.parser.add_argument('--dataroot2', type=str, required=True, help='path of data')
    self.parser.add_argument('--phase', type=str, default='train', help='phase for dataloading')
    self.parser.add_argument('--batch_size', type=int, default=2, help='batch size')
    self.parser.add_argument('--resize_size', type=int, default=280, help='resized image size for training')
