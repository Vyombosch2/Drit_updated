...
class dataset_unpair(data.Dataset):
  def __init__(self, opts):
    self.dataroot1 = opts.dataroot1
    self.dataroot2 = opts.dataroot2
    # A
    images_A = os.listdir(self.dataroot1)
    self.A = [os.path.join(self.dataroot1, x) for x in images_A]

    # B
    images_B = os.listdir(self.dataroot2)
    self.B = [os.path.join(self.dataroot2, x) for x in images_B]
